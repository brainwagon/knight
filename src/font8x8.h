...
/**
 * IBM VGA 8x8 bitmap font for ASCII characters 32-126.
 * Each character is 8 bytes, one byte per row.
 * MSB (Bit 7) is the leftmost pixel.
 */
static const uint8_t font8x8_basic[128][8] = {
    [0 ... 31] = {0,0,0,0,0,0,0,0}, // Non-printable
    ...
    [53] = {0x7E, 0x60, 0x3E, 0x06, 0x06, 0x66, 0x3C, 0x00}, // 5
    ...
    [81] = {0x3C, 0x66, 0x66, 0x66, 0x6A, 0x3C, 0x02, 0x00}, // Q
    ...
    [112] = {0x00, 0x00, 0xDC, 0x66, 0x66, 0x7C, 0x60, 0x60}, // p
    [113] = {0x00, 0x00, 0x3E, 0x66, 0x66, 0x3E, 0x06, 0x06}, // q
    [114] = {0x00, 0x00, 0xDC, 0x76, 0x60, 0x60, 0x60, 0x00}, // r
    [115] = {0x00, 0x00, 0x3C, 0x60, 0x3C, 0x06, 0x3C, 0x00}, // s
